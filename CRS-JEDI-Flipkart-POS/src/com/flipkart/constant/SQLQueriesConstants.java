...
public class SQLQueriesConstants {
    ...
    // Student Queries
      ...
      public static final String VIEW_GRADE = "select * from student_reg_course inner join course on course.courseId = student_reg_course.courseId where studentId = ? AND isApproved = 1;";
      ...
      public  static  final  String GET_ENROLLED_STUDENTS = "select student_reg_course.studentId,student.userId,user.name from student_reg_course join student on student.studentId = course.studentId join user on user.userId = student.userId where courseId = ?";
